...
## สิ่งที่มีในเว็บ
- ฟอร์มตามเนื้อหาใน PDF (หมายเลขบัตร 3 หลัก, ประเภทบัตร STANDARD/GOLD/PLATINUM, ชื่อ-นามสกุล, สถานะการเข้าพัก, เบอร์โทร, บริษัท, โรงแรม) เพิ่มวันที่/เวลาเช็คอินเพื่อรองรับการจัดที่พัก
...
4. รันฟังก์ชัน `initialize` หนึ่งครั้ง (กดอนุญาตสิทธิ์) หรือกลับมาที่ชีทแล้วใช้เมนู **ระบบลงทะเบียน → Initialize ชีท**
   - จะได้ชีทเดียวชื่อ `_database` แบ่งเป็น 2 ตารางในแผ่นเดียว: ตารางตัวเลือก (dropdown) 4 คอลัมน์ เว้น 1 คอลัมน์ แล้วตารางบันทึกข้อมูล 11 คอลัมน์
   - แก้รายชื่อโรงแรม/บริษัทได้ในตารางตัวเลือกฝั่งซ้าย
